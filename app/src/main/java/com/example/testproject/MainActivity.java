...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onStart() {
        ...
        mRequestLocationUpdatesButton = (Button) findViewById(R.id.btnServiceOn);
        mRemoveLocationUpdatesButton = (Button) findViewById(R.id.btnServiceOff);
